...
public class ServletModificar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            final String drag1Text = request.getParameter("drag1Text");
            final String drag2Text = request.getParameter("drag2Text");
            final String drag3Text = request.getParameter("drag3Text");
            final String drag4Text = request.getParameter("drag4Text");
            ...
            final String target1Text = request.getParameter("target1Text");
            final String target2Text = request.getParameter("target2Text");
            final String target3Text = request.getParameter("target3Text");
            final String target4Text = request.getParameter("target4Text");
